...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="hidden md:flex md:text-lg lg:text-xl backdrop-blur-md px-10 bg-white/10 h-full md:justify-end md:max-w-[670px] transition-all duration-400 lg:max-w-4xl">
